...
const caseStudies = [
  {
    ...
    accent: '#1a1a2e',
    tags: ['B2B SaaS', 'Product Strategy', 'Design + Code'],
  },
  {
    slug: 'clearcase',
    title: 'ClearCase',
    accent: '#2c3e50',
    tags: ['B2B SaaS', 'Product Strategy', 'Responsive Web'],
  },
  {
    slug: 'griefshare',
    title: 'GriefShare',
    accent: '#1a1a1a',
    tags: ['Online Search', 'Research Strategy', 'Responsive Web'],
  },
  {
    slug: 'leadsuite',
    title: 'LeadSuite',
    accent: '#1c3557',
    tags: ['B2B SaaS', 'Product Strategy', 'Information Architecture'],
  },
  {
    slug: 'deposify',
    title: 'Deposify',
